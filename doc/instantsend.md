...
This mechanism has been integrated into Bitcore-Node-STAP which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/umarucoin/insight-api-stap#web-socket-api](https://github.com/umarucoin/insight-api-stap#web-socket-api) 
* API: [https://github.com/umarucoin/insight-api-stap#instantsend-transactions](https://github.com/umarucoin/insight-api-stap#instantsend-transactions) 
...
By default, the STAP Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the STAP Core daemon:
