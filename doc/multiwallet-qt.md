...
Only requiring some minor changes is stap.cpp.
...
Changes to stap.cpp
----------------------
stap.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
