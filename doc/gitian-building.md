...
git clone https://github.com/stappay/stap
```
...
```bash
    ...
    From https://github.com/stappay/stap
...
[stap/gitian.sigs](https://github.com/stappay/gitian.sigs/) repository, or if that's not possible to create a pull
request.
