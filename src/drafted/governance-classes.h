 ...
 *
 *   // network
 *   CSTAPNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.stap.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CSTAPNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: STAPNetwork
// //   -- signature requirements : Key1(User)
// class CSTAPNetworkVariable : public CGovernanceObject
// {
// private:
