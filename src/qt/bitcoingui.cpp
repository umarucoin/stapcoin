    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("STAP Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a STAP address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and stap: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About STAP Core"), this);
    aboutAction->setStatusTip(tr("Show information about STAP Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for STAP Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your STAP addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified STAP addresses"));
    ...
    openAction->setStatusTip(tr("Open a stap: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the STAP Core help message to get a list with possible STAP Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("STAP Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to STAP network", "", count));
}
...
{
    QString strTitle = tr("STAP Core"); // default title
