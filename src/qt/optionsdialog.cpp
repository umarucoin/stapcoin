    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("STAP-light"), QVariant("light"));
    ui->theme->addItem(QString("STAP-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("STAP-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("STAP-traditional"), QVariant("trad"));
