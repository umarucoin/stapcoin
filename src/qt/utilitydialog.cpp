    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("STAP Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About STAP Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  stap-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the STAP in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 STAP, 0.1 STAP, 1 STAP and 10 STAP -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://umarucoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://umarucoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("STAP Core is shutting down...") + "<br /><br />" +
